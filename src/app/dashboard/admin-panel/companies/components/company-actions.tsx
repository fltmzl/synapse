...
export function CompanyActions({ company }: CompanyActionsProps) {
  ...
  const { deleteCompanyMutation } = useCompanyMutation();
    ...
    <>
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="icon-sm" asChild>
          <Link href={`/dashboard/admin-panel/companies/edit/${company.id}`}>
        ...
        <AlertDialogContent className="py-4 px-5">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              company &quot;{company.name}&quot; and remove its data from our
              servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
