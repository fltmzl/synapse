...
export default function FindDataPage() {
  ...
  return (
    <section className="max-w-7xl mx-auto py-12 lg:py-25 w-full px-6 flex flex-col gap-16">
      {/* Header */}
      ...
      <div className="w-full max-w-[58rem] mx-auto ">
        <div className="bg-[var(--section)] border rounded-[14px] p-2">
          {/* Source Filter */}
          <div className="flex gap-2 p-4 overflow-x-auto scrollbar-hidden lg:overflow-x-hidden ">
      ...
      <hr className="border max-w-3xl flex items-center justify-center mx-auto w-full" />
      ...
      <div className="text-center justify-center items-center flex flex-col gap-8">
        ...
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-3 gap-6">
          {infoOptions.map((opt) => (
            ...
            >
              <CardContent className="p-5 gap-6 flex flex-col justify-between h-full">
                {/* Header (Icon + Arrow) */}
