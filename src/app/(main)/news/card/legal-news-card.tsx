            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  <h3 className="font-medium text-lg leading-[140%] tracking-tight line-clamp-2 group-hover:text-primary">
                    {title}
                  </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="flex flex-wrap gap-2 ">
                    {tags.map((tag) => (
                      <Badge
                        key={tag}
                        className="text-foreground px-2 py-1 text-sm font-regular leading-[140%] tracking-tighter bg-border"
                      >
                        {tag}
                      </Badge>
                    ))}
