...
import { MessageCircle2FilledIcon } from "./message-circle-2-filled-icon";

type Size = "md" | "lg";

export default function MessageGreenIcon({
  withShadow = true,
  size = "lg"
}: {
  withShadow?: boolean;
...
function InnerIcon({ size = "lg" }: { size?: Size }) {
  return (
    ...
    >
      <MessageCircle2FilledIcon fontSize={18} className="text-white" />
    </div>
  );
}
