  ...
  "px-6 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-medium tracking-[-0.01em] leading-[20px] transition-all disabled:pointer-events-none disabled:opacity-50 disabled:bg-muted disabled:text-slate-600 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive tracking-normal",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-primary bg-[#ECF4EC] text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost:
      ...
      size: {
        default: "px-6 py-[9.5px] has-[>svg]:px-4",
        sm: "h-8 py-2 rounded-md gap-1.5 px-3 has-[>svg]:px-3 text-xs",
        md: "h-8 py-2 rounded-md gap-1.5 px-3 has-[>svg]:px-3 text-xs",

        lg: "h-12 py-3 rounded-lg px-4 has-[>svg]:px-4",
        icon: "size-9"
      }
    },
    defaultVariants: {
