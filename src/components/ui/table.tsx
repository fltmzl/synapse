...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto border-y bg-background scrollbar-custom"
    >
      <table
        data-slot="table"
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors h-12",
        className
      )}
      {...props}
    />
  ...
  return (
    <th
      ...
      className={cn(
        ...
        "py-2.5 px-4 text-xs font-semibold text-muted-foreground",
        className
      )}
      {...props}
    />
